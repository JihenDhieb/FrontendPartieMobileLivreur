...
class MyRevenueMonth extends StatefulWidget {
  final Map<String, dynamic> userData;
  MyRevenueMonth({required this.userData});
  @override
  MyRevenueMonthState createState() => MyRevenueMonthState();
}

class MyRevenueMonthState extends State<MyRevenueMonth> {
  ...
  Future<void> displayDataFromBackend() async {
    ...
    final response = await http.get(
      Uri.parse('http://192.168.1.26:8080/User/monthRevenue/$id'),
    );
